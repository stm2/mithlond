                    ...
                    <form action="{{ route('games.store') }}" method="post">
                        ...
                        <div class="form-group">
                            <label for="title">Game name</label> <input type="text"
                                ...
                                name="name" placeholder="Game name" value="{{ old('name') }}">
                            <!--  -->
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                ...
                                placeholder="description is shown to users">{{ old('description') }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            <label for="url">URL</label> <input type="text"
                                ...
                                name="url" placeholder="https://yourproject.game"
                                value="{{ old('url') }}">
                            <!--  -->
                            @error('url')
                            <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="form-group">
                            <label for="url">Email</label> <input type="text"
                                ...
                                name="email" placeholder="Email for sending orders"
                                value="{{ old('email') }}">
                            <!--  -->
                            @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
